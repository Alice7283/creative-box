...
超過這10分鐘以外的時間，場佈、活動、清潔與撤場都請包含在租用時段中。若超過租借時間離場，會額外收取一小時超時費NT$450。`
      },
      {
        ...
        body: `{{name}}您好，場勘原則上安排於平日10:30–18:20之間，場勘時間預設為半小時。
...
我們幫您確認希望場勘的日期和時段，是否有其他客人租用，稍後回覆，謝謝。`
      },
      {
        ...
        body: `{{name}}您好，已為您安排於{{visitDate}} {{visitTime}}參觀花盒二館，場勘時間預設為半小時。
...
🌸 林小姐 0901327057`
      ...
      {
        id: 'cleaning_tools', category: 'day', title: '掃把抹布提醒', summary: '一樓打烊前交接清潔工具',
        hint: '一樓店家打烊前，提醒客人清潔工具位置與歸位方式。', fields: ['name'],
        body: `{{name}}您好，一樓綠豆蒜製研所打烊前，會把掃把交代給你們。

抹布一樓、二樓的回收櫃上各有一條，或會晾在二樓欄杆上。使用完畢後，請清洗乾淨並幫我們晾回原位喔，謝謝。`
      },
      {
